...
L["Disabled"] = "|cffff0000Выключено|r"
...
L["%s to toggle calendar."] = "%s для переключения календаря."
L["%s to use local computer time."] = "%s для отображение локального времени."
L["%s to use game server time."] = "%s для отображение серверного времени."
L["%s to use standard (12-hour) time."] = "%s для отображения в 12-часовом формате."
L["%s to use military (24-hour) time."] = "%s для отображения в 24-часовом формате."
...
--------------------------------------------
L["Network Stats"] = "Статистика сети"
...
L["Current Honor Points: "] = "Текущаие очки чести: "
L["Current Standing: "] = "Текущее состояние: "
L["Current XP: "] = "Текущий опыт: "
L["Rested Bonus: "] = "Бонус отдыха: "
L["%s of normal experience gained from monsters."] = "%s от нормального опыта, получаемого после убийства монстров."
L["You must rest for %s additional hours to become fully rested."] = "Вы должны отдохнуть в течение %s часов, чтобы полностью отдохнуть."
L["You must rest for %s additional minutes to become fully rested."] = "Вы должны отдохнуть в течение %s минут, чтобы полностью отдохнуть."
L["You should rest at an Inn."] = "Вы должны отдохунть в Таверне."
...
L["%s to disable sticky bars."] = "%s для отключение прилипания баров."
L["%s to enable sticky bars."] = "%s для включение прилипания баров."  
L["Sticky Minimap bars enabled."] = "Включены липкие бары миникарты."
L["Sticky Minimap bars disabled."] = "Отключены липкие бары миникарты."
