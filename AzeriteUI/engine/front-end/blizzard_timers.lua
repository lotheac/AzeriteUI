...
local Layout = CogWheel("LibDB"):GetDatabase(ADDON..": Layout [BlizzardTimers]")
...
--AZ_TestTimer = function()
--	TimerTracker_OnLoad(TimerTracker)
--	TimerTracker_OnEvent(TimerTracker, "START_TIMER", 1, 20, 20)
--	Module:UpdateTimerTrackers()
--end 
-- /run AZ_TestTimer()
