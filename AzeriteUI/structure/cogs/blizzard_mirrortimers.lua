...
Module.StyleTimer = function(self, frame)
	...
	for i = 1,select("#", frame:GetRegions()) do 
		...
		if region and region:IsObjectType("texture") then 
			region:SetTexture(GetMediaPath("blank"))
	...
	local bar = timer.bar
	bar:SetSize(111,14)
	bar:SetStatusBarTexture(GetMediaPath("cast_bar"))
	...
	backdrop:SetTexture(GetMediaPath("cast_back"))
	...
	if spark then 
		...
		spark:SetTexture(GetMediaPath("blank")) 
	...
	if border then 
		...
		border:SetTexture(GetMediaPath("blank"))
