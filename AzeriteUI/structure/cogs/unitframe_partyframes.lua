...
local Style = function(self, unit, id, ...)
	...
	health:SetStatusBarTexture(GetMediaPath("cast_bar"))
	...
	healthBg:SetTexture(GetMediaPath("cast_back"))
	...
	absorb:SetStatusBarTexture(GetMediaPath("cast_bar"))
	...
	portraitBg:SetTexture(GetMediaPath("party_portrait_back"))
	...
	portraitShade:SetTexture(GetMediaPath("shade_circle"))
	...
	portraitFg:SetTexture(GetMediaPath("party_portrait_border"))
	...
	groupRoleBg:SetTexture(GetMediaPath("point_plate"))
	...
	roleHealer:SetTexture(GetMediaPath("grouprole-icons-heal"))
	...
	roleTank:SetTexture(GetMediaPath("grouprole-icons-tank"))
	...
	roleDPS:SetTexture(GetMediaPath("grouprole-icons-dps"))
