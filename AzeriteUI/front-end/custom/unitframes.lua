...
local StyleSmallFrame = function(self, unit, id, Layout, ...)
	...
	if Layout.UseBuffs then 
		...
		buffs.buffFilter = Layout.BuffFilter -- buff specific filter passed to blizzard API calls
		buffs.BuffFilter = Layout.BuffFilterFunc -- buff specific filter function
	...
	if Layout.UseDebuffs then 
		...
		debuffs.debuffFilter = Layout.DebuffFilter -- debuff specific filter passed to blizzard API calls
		debuffs.DebuffFilter = Layout.DebuffFilterFunc -- debuff specific filter function
