...
-- I'll add these back on demand, then clean up before release

--Colors.outofmana = prepare( 77/255, 77/255, 179/255 )
--Colors.outofrange = prepare( 255/255, 0/255, 0/255 ) 
--Colors.green = prepare( 38/255, 201/255, 38/255 )
--Colors.gold = prepare( 255/255, 180/255, 64/255 )
--Colors.blue = prepare( 64/255, 128/255, 255/255 )
--Colors.darkred = prepare( 178/255, 25/255, 25/255 )
--Colors.offwhite = prepare( 201/255, 201/255, 201/255 )
--Colors.prefix = prepare( 255/255, 238/255, 170/255 )
--Colors.detail = prepare( 250/255, 250/255, 250/255 )
--Colors.boa = prepare( 230/255, 204/255, 128/255 ) 
--Colors.pvp = prepare( 163/255, 53/255, 238/255 )
...
Colors.power.ENERGY = prepare(40/255, 205/255, 141/255 ) -- Rogues, Druids, Monks
